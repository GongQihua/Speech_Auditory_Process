...
def invplpspectra (aspc, fs = 16000, nfft = 1024, fbtype = 'bark', min_freq = 0, max_freq = 8000, sumpower = True, 
                   band_width = 1, win_time = 0.020, hop_time = 0.010, excitation = [], preemph = 0.97):
    if max_freq == 0:
        max_freq = fs/2
...
def invaudspec(aspectrum, fs = 16000, nfft = 1024, fbtype = 'bark', 
